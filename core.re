...
# CX rules
acPostProcForPut {
    ON($objPath like "/CineGridExchange/home/rods/test/*") {
	msiSysChksumDataObj;
#       msiSysReplDataObj("ampasCXResc", "null");
#	msiDataObjRsync($objPath, "IRODS_TO_IRODS", "ampasCXResc", "/CineGridExchange/home/rods/test-ampasCXResc", *OUT);
	msiCollRsync("/CineGridExchange/home/rods/test", "/CineGridExchange/home/rods/test-ampasCXResc", "ampasCXResc", "IRODS_TO_IRODS", *OUT);
    }
}
acPostProcForPut {
    ON($objPath like "/CineGridExchange/home/rods/Metadata/*") {
        msiExecCmd("metadata.py", $filePath, "null", "null", "null", *OUT);
    }
}
